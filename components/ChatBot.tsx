...
const FAQ_RESPONSES: Record<string, string> = {
  ...
  'team': 'Our leadership includes Robin Bundy (Vision & Growth), Sheleeah Ballard (Culture & Community), and Ricky Ballard (Strategy & Development).',
  'robin bundy': 'Robin Bundy is our Vision & Growth leader with 15+ years scaling businesses from startup to acquisition.',
  'sheleeah ballard': 'Sheleeah Ballard leads Culture & Community with expertise in organizational development and team building.',
  'ricky ballard': 'Ricky Ballard oversees Strategy & Development with a track record of operational excellence and business transformation.',
